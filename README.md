...
[![Transformers.js](https://img.shields.io/badge/HuggingFace-Transformers.js-FFD21E?style=flat-square&logo=huggingface&logoColor=black)](https://huggingface.co/docs/transformers.js/index)

[Features](#-features) · [Architecture](ARCHITECTURE.md) · [Gamification](GAMIFICATION.md) · [Tech Stack](#-tech-stack) · [Installation](#-installation) · [Usage](#-usage) · [Contributing](CONTRIBUTING.md) · [Changelog](CHANGELOG.md) · [License](#-license)
...
- Models run fully in-browser using offscreen inference (no backend required).
- Models auto-download on extension load and cached artifacts are reused.
